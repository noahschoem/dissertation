...
\begin{remark}\thlabel{magidor_factoring}
  ...
  Additionally, by \thref{product_cc_closed}, after forcing with $\mathbb{M}\left(\vec{U}\right)_{\xi,\beta}$, the partial order $(\mathbb{M}\left(\vec{U}\right)^{\xi,\beta},\leq^*)$ remains $<\beta^+$-distributive.
\end{remark}
