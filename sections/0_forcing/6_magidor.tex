...
\end{lemma}
This appears as Lemma 4.5 of \cite{magidor_chg_cof}, and we give a proof here:
...
A proof can be found in \cite{fuchs_magidor} that makes use of much stronger Prikry-type lemmas than \thref{magidor_prikry_type_open_dense} and \thref{magidor_prikry_type_sentential_better};
...
This helps for arguing mutual stationarity results for restricted cofinality below $\beta_0$, by a lemma from the original mutual stationarity paper of \cite{foreman_magidor_ns_ns}.
