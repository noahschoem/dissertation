...
Koepke's mutual stationarity result in (todo: cite koepke-omega1) implicitly rephrases \thref{ms_prikry} as a Ramsey-theoretic result, in the following sense:

\begin{definition}[Definition 2.2 of (todo: cite koepke-omega1)]
...
Koepke has arguments pertaining to such $F$ and in a much earlier paper (todo: cite koepke-free-subset) proved the following:
