...
Koepke's mutual stationarity result in \cite{koepke_omega_1} implicitly rephrases \thref{ms_prikry} as a Ramsey-theoretic result, in the following sense:

\begin{definition}[Definition 2.2 of \cite{koepke_omega_1}]\thlabel{koepke_types}
...
\begin{theorem}[\cite{koepke_free_subset}; also Proposition 2.3 of \cite{koepke_omega_1}]\thlabel{koepke_mr}
