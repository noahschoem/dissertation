...
\begin{proof}
  ...
  By regressiveness of $g_{\alpha_1,\dots,\alpha_k}$, for each $\alpha_1<\dots<\alpha_k$ in $[\lambda\setminus(\alpha+1)]^{<\omega}$, there is an $A_{\alpha,\alpha_1,\dots,\alpha_k}\in U_{\alpha}$ such that $g_{\alpha_1,\dots,\alpha_k}$ is constant on $A_{\alpha,\alpha_1,\dots,\alpha_k}$, say with value $\delta_{\alpha,\alpha_1,\dots,\alpha_k}$.
  
  Let \[
    B_{\alpha}=\left(\bigcap_{\alpha<\alpha_1<\dots<\alpha_k<\lambda} A_{\alpha,\alpha_1,\dots,\alpha_k}\right)
  \]
  Furthermore, let $\tensor*[^{k}_{\beta}]{H}{^{'}_{\alpha}}=\tensor*[^{k}_{\beta}]{H}{_\alpha}\cap B_\alpha$ and define
  \[
  ...
  But since $\beta_0\in B_{\alpha_0}$, we have that in fact $\gamma_{\alpha_1,\dots,\alpha_k}(\beta_0)=\delta_{\alpha_0,\dots,\alpha_k}$ as desired.
