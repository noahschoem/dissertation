...
\begin{lemma}\thlabel{simult_indisc_easy}
  Suppose $\overrightarrow{U}=\seq{U_\alpha \mid \alpha<\lambda}$ is a sequence of normal measures on $\kappa$ and suppose that $f:[\kappa]^{<\omega}\to\kappa$ is regressive, i.e. for all $x$, $f(x)<\min(x)$.
...
\begin{proof}
  ...
  Since $f$ is regressive, so is $\tensor*[_{\beta_0}]{f}{}$; so by the induction hypothesis, for each $\beta_0$, there is a sequence $\tensor*[^{k}_{\beta_0}]{\overrightarrow{H}}{}$ such that for every $\alpha_1<\dots<\alpha_k$, $\tensor*[_{\beta_0}]{f}{}\upharpoonright \prod^\uparrow_{1\leq i<k+1} \tensor*[^{k}_{\beta_0}]{H}{_{\alpha_i}}$ is constant, say with value $\gamma_{\alpha_1,\dots,\alpha_k}(\beta_0)$.
  
  Let $g_{\alpha_1,\dots,\alpha_k}:\kappa\to\kappa$, $g_{\alpha_1,\dots,\alpha_k}(\beta)=\gamma_{\alpha_1,\dots,\alpha_k}(\beta)$.
  Since $g_{\alpha_1,\dots,\alpha_k}$ is regressive,
  for each $\alpha<\alpha_1$, there is an $A_{\alpha,\dots,\alpha_k}\in U_{\alpha}$ such that $g_{\alpha_1,\dots,\alpha_k}$ is constant on $A_{\alpha,\dots,\alpha_k}$, say with value $\delta_{\alpha,\dots,\alpha_k}$.
  
  Let \[
    A_{\alpha}=\left(\bigcap_{\alpha<\alpha_1<\dots<\alpha_k<\lambda} A_{\alpha,\alpha_1,\dots,\alpha_k}\right)
  \]
  Furthermore, let $\tensor*[^{k}_{\beta}]{H}{^{'}_{\alpha}}=\tensor*[^{k}_{\beta}]{H}{_\alpha}\cap A_\alpha$ and define
  ...
  We wish to verify that for every $\beta_i\in \tensor*[^{k+1}]{H}{_{\alpha_i}}$, $\beta_i<\beta_{i+1}$, we have $f(\{\beta_0,\dots,\beta_k\})=\delta_{\alpha_0,\dots,\alpha_k}$.
  ...
  But since $\beta_0\in A_{\alpha_0}$, we have that in fact $\gamma_{\alpha_1,\dots,\alpha_k}(\beta_0)=\delta_{\alpha_0,\dots,\alpha_k}$ as desired.
...
\begin{lemma}\thlabel{simult_indisc_useful}
  Suppose $\overrightarrow{U}=\seq{U_\alpha \mid \alpha<\lambda}$ is a system of normal measures on $\kappa$ and suppose that $f:[\kappa]^{<\omega}\to\kappa$ is regressive.
