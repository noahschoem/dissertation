...
Its introduction implicitly takes this view in the form of the following (a weaker version of which appears as Theorem 7 and Corollary 8 in (TODO: cite foremanmagidor-nsns)):
...
Koepke's argument in (todo: cite koepke, ms every other, omega 1) does not depend on cardinal arithmetic, so should readily achieve $MS(\seq{\aleph_{2n+3}\mid n<\omega; cof(\leq\omega_1)}) + \lnot SCH_{\aleph_\omega})$.

Ben-Neria's arguments in (todo: cite benneria2017) assume $GCH$, but suggest a framework for achieving mutual stationarity principles with the failure of $GCH$.
