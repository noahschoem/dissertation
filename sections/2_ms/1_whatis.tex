...
\begin{lemma}[Folklore]
  ...
  \end{enumerate}
\end{lemma}
(todo: cite foremanmagidor-nsns) cite this as implicit in (todo: cite their citation of Baumgartner).
...
\begin{lemma}[Lemma 23 of (todo: cite foremanmagidor-nsns)]\thlabel{mutual_stationarity_finite_change}
