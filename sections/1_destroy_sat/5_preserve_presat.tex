...
Thus after forcing with $\mathcal{B}_I * \dot{j}_I(\mathbb{Q})$, we have that $\mathbb{P}(\kappa)*\dot{\mathbb{R}}$ is $\kappa^+$-proper on a stationary set.
...
Since $\mathcal{B}_I$ is $\delta$-proper on $IA_{<\delta}$, by Fact \ref{proper-implies-presat} it suffices to show that 
\[
  \forces_{\mathcal{B}_I} ``\dot{j}_I(\mathbb{Q}))\text{ is proper on a stationary subset of }\dot{IA_{<\delta}}"
\]

By a slight modification of Lemma \ref{jQ-ultVI},
...
\item $\dot{(j_I(\mathbb{Q}))}\upharpoonright [\kappa,\delta)$ is forced to be an Easton support iteration of $\delta$-cc posets
...
By assumption, either $Inacc_\delta$ is bounded in $\delta$ or stationary in $\delta$, and thus $\dot{(j_I(\mathbb{Q}))}\upharpoonright [\kappa,\delta)$ is nontrivial either boundedly often or has $\delta$-cc iterates on a stationary subset of $\delta$.
Thus $\dot{(j_I(\mathbb{Q}))}\upharpoonright [\kappa,\delta)$ is $\delta$-cc.

Hence, $\mathcal{B}(\mathcal{B}_I * \dot{j}_I(\mathbb{Q}))$ is forcing-equivalent to a poset $\delta$-proper on a stationary subset of $\mathcal{P}_\delta^*(H_\theta)$ followed by a finite iteration of $\delta$-cc and $<\delta$-closed forcings.
Thus by Lemma \ref{lemma-iaposets}\ref{lemma-iaposets:iter}, $\mathcal{B}(\mathcal{B}_I * \dot{j}_I(\mathbb{Q}))$ is $\delta$-presaturated.
...
which once again we want to show is $\delta$-proper on a stationary subset of $\dot{IA_{<\delta}}$.
...
Thus $\mathcal{B}_I * \dot{j_I(\mathbb{Q})}$ a finite iteration of forcings all $\delta$-proper on the same stationary subset of $IA_{<\delta}$.
Thus by Fact \ref{proper-implies-presat}, $\mathcal{B}_I * \dot{j_I(\mathbb{Q})}$ is $\delta$-presaturated.
