...
As in the proof of Theorem \ref{bigthm}\ref{bigthm:savepresat}, we may without loss of generality suppose that $I$ concentrates on regular cardinals below $\kappa$; else $\delta$ will be singular, so $\dot{j}_I(\mathbb{Q})(\delta)$ will be trivial.
