...
\begin{definition}\label{strongly-proper}
...
The definitions of $\mathcal{P}_{\delta}^*(H)$ and \ref{strongly-proper} are as in \cite{cox_eskew_kill_sat_save_presat}.
...
In a sense, internal approachability is preserved by any generic extension, as noted in \cite{cox_eskew_kill_sat_save_presat}:
...
Part \ref{lemma-iaposets:closed} is due to \cite{foreman_magidor_lcs_ctx_ch}. %I can't specifically find it here, but Cox & Eskew say it's in there.
