...
For a $\kappa$-complete, $\kappa^+$ saturated $I\in V$ and a $\kappa$-cc poset $\mathbb{Q}\in V$, $\overline{I}$ is $\kappa^+$-saturated in $V^\mathbb{Q}$ if and only if $\forces_{\mathcal{B}_I} \dot{j}_I(\mathbb{Q})$ is $\kappa^+$-cc.
\end{lemma}
