...
\begin{proof}
  ...
  For each $g$ a proper initial segment of $\seq{\beta_n \mid n<\omega}$, by \thref{magidor_collapse_prikry_open_dense}, fix some $c_g$, some condition $p_{g,c_g}=(g,c_g,A^{g,c_g},C^{g,c_g})$ and an $a_g\in [\omega]^{<\omega}$ such that every $a_g$-step extension of $p_{g,c_g}$ is in $\mathcal{D}$.
  ...
  Thus, by construction of $p_{g,c_g}$, $q\frown (\vec{\beta}\upharpoonright m_g)\in\mathcal{D}$.
