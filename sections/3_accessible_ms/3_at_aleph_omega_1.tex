...
We fix $\vec{U}=\seq{U_\xi \middle| \xi<\lambda}$, $\lambda<\kappa$, $Y_\xi$, and $\seq{r_\beta^\alpha \middle| \beta<\alpha<\lambda}$ as in Section 1.
...
The real work in proving this conjecture is emulating the argument of (Fuchs), but with the interleaved collapses.
