...
\begin{fact}\thlabel{magidor_collapse_factoring}
  ...
  due to our use of the reflected guiding generics $\seq{k_\alpha^\beta\middle| \alpha<\beta, \beta<\lambda}$, for each $\xi$ a limit point below $\lambda$ and each $\beta\in Y_\xi$, relative to the weakest $p$ for which $f^p(\xi)=\beta$, 
  \[
